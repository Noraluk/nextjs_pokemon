...
import PokemonListSearch from "./pokemon_list_search";
import { PokemonDetail, PokemonDetailLoading } from "./pokemon_detail";
import clsx from "clsx";
import styles from "@/components/pokedex/pokedex.module.css";

export default function Pokedex({ pokemonSearch }: { pokemonSearch?: string }) {
